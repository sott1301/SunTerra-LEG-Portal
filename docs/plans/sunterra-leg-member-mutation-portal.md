...
Neubau als separates Repository: ein eigenständiges Portal für Teilnehmer, LEG-Vertreter und kombinierte Gemeinde/EW-Rolle. Die Produktmarke ist SunTerra LEG; Basadingen-Schlattingen beschreibt Gebiet und Gemeinde/EW-Partnerkontext. Keine Abrechnung, kein Inkasso, kein Settlement, keine Bankdaten, keine 15-Minuten-Messwerte.
...
Rollen: `participant`, `leg_admin`, `partner_admin`, `platform_admin`. `partner_admin` ist die kombinierte Gemeinde/EW-Rolle für Basadingen-Schlattingen, mit minimalem Mitgliederregister plus Mutationspaketen.
...
Fristenmodell: Q1 Jan-Mar, Q2 Apr-Jun, Q3 Jul-Sep, Q4 Okt-Dez. Teilnehmer beantragen reguläre Eintritte, Austritte und Mutationen mit 3 Monaten Frist zum Quartalsende. LEG-Vertreter meldet Gemeinde/EW mit 2 Monaten Frist. `entry` braucht konstitutive Entry-Freigabe; Nicht-`entry`-Mutationen gelten bei Einreichung als Teilnehmererklärung und laufen vor Paketierung durch den Paketbereit-Check. Wirksamkeitsdaten folgen dem LEG-Vertrag. Auszug, Todesfall, Eigentümer-/Mieterwechsel, Messpunktfehler und Gemeinde/EW-Korrektur sind begründete Sondermutationen.

Mutationpakete: paketbereite Mutationen werden gesammelt, dann als unveränderliches Paket mit CSV, PDF, JSON, Hash, Stichtag, Frist, Actor und Statushistorie erzeugt. Gemeinde/EW kann Status setzen: empfangen, in Prüfung, verarbeitet, Rückfrage, technisch nicht möglich; immer mit Referenz oder Begründung. Partnerstatus erzeugt Folgearbeit, ändert Mutation oder Mitgliedschaft aber nicht automatisch.
...
Backend-Tests: Fristenrechner für Quartale und Sonderfälle, Consent-Evidence, IdentityVerification-Level, Entry-Freigabe, Paketbereit-Check, Paket-Immutability, Partnerstatus, RBAC/Redaction, Audit-Hashing, Datei-Zugriffsschutz, Export-Golden-Files.

Frontend-Smokes: Teilnehmer-Onboarding, Kontaktänderung direkt, meldepflichtige Mutation, Entry-Freigabe, Paketbereit-Check, Paketbildung, Partner-Inbox, Partner-Mitgliederregister, Deutsch-only UI.
